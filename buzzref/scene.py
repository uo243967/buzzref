...
from buzzref.items import item_registry, BuzzErrorItem, sort_by_filename
from buzzref.selection import MultiSelectItem, RubberbandItem


logger = logging.getLogger(__name__)


class BuzzGraphicsScene(QtWidgets.QGraphicsScene):

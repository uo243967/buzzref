...
"""BuzzRef's native file format is using SQLite. Embedded files are
...
from buzzref.items import BuzzPixmapItem, BuzzErrorItem
from .errors import BuzzFileIOError, IMG_LOADING_ERROR_MSG
...
class SQLiteIO:
    ...
    def write_data(self):
        ...
        keep = {item.original_save_id
                for item in self.scene.items_by_type(BuzzErrorItem.TYPE)}

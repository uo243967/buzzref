...
from buzzref.constants import COLORS
from buzzref.selection import SelectableMixin
...
class BuzzItemMixin(SelectableMixin):
...
@register_item
class BuzzPixmapItem(BuzzItemMixin, QtWidgets.QGraphicsPixmapItem):
...
@register_item
class BuzzTextItem(BuzzItemMixin, QtWidgets.QGraphicsTextItem):
    ...
    def create_copy(self):
        item = BuzzTextItem(self.toPlainText())
        item.setPos(self.pos())
        item.setZValue(self.zValue())
        item.setScale(self.scale())
        item.setRotation(self.rotation())
...
@register_item
class BuzzPathItem(BuzzItemMixin, QtWidgets.QGraphicsItem):
    ...
    def create_copy(self):
        item = BuzzPathItem(strokes=copy.deepcopy(self.strokes))
        item.setPos(self.pos())
        item.setZValue(self.zValue())
        item.setScale(self.scale())
        item.setRotation(self.rotation())
...
@register_item
class BuzzErrorItem(BuzzItemMixin, QtWidgets.QGraphicsTextItem):
    ...
    def create_copy(self):
        item = BuzzErrorItem(self.toPlainText())
        item.setPos(self.pos())
        item.setZValue(self.zValue())
        item.setScale(self.scale())
        item.setRotation(self.rotation())
